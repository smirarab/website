...
I have noticed that most English speakers prefer to start my name with a Sh sound rather an S; so my only tip is, start with an S and end on a Sh (like you would for slash). 
